...
describe "Debunker.run_command" do
  before do
    ...
    @context = Debunker.binding_for(o)
  end

  it 'performs a simple ls' do
    @context.eval("hokey_pokey = 10")
    Debunker.run_command "ls", :context => @context, :output => out = StringIO.new
  ...
  it 'can perform a show-source' do
    Debunker.run_command "show-source drum", :context => @context, :output => out = StringIO.new
