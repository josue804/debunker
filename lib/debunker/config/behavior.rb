module Debunker::Config::Behavior
  ASSIGNMENT     = "=".freeze
  ...
  module Builder
    ...
    #
    # @param [Debunker::Config, nil] default
  ...
  def initialize(default = Debunker.config)
    @default = default
    @lookup = {}
  ...
  #
  # @return [Debunker::Config::Behavior]
  ...
  #   a value.
  #
  # @raise [Debunker::Config::ReservedKeyError]
