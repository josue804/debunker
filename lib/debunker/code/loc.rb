class Debunker
  class Code
    ...
    # parameter) can be changed via instance methods. `Debunker::Code` heavily uses
    # this class.
    #
    # @api private
    # @example
    ...
    class LOC
      ...
      def add_line_number(max_width = 0, color = false)
        ...
        colorized_lineno = color ? Debunker::Helpers::BaseHelpers.colorize_code(padded) : padded
