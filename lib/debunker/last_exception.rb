#
# {Debunker::LastException} is a proxy class who wraps an Exception object for
# {Debunker#last_exception}. it extends the exception object with methods that
# help debunker commands be useful.
#
# the original exception object is not modified and method calls are forwarded
# to the wrapped exception object.
#
class Debunker::LastException < BasicObject
