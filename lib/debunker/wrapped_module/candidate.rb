...
class Debunker
  class WrappedModule
    ...
    class Candidate
      include Debunker::Helpers::DocumentationHelpers
      include Debunker::CodeObject::Helpers
      extend Forwardable
      ...
      # Methods to delegate to associated `Debunker::WrappedModule
      # instance`.
      ...
      # @raise [Debunker::CommandError] If `rank` is out of bounds.
      # @param [Debunker::WrappedModule] wrapper The associated
      #   `Debunker::WrappedModule` instance that owns the candidates.
      ...
      #   `Debunker::WrappedModule#number_of_candidates() - 1`
      ...
      # @raise [Debunker::CommandError] If source code cannot be found.
      ...
      def source
        ...
        @source ||= strip_leading_whitespace(Debunker::Code.from_file(file).expression_at(line, number_of_lines_in_first_chunk))
      end
      ...
      def doc
        return nil if file.nil?
        @doc ||= get_comment_content(Debunker::Code.from_file(file).comment_describing(line))
      end
