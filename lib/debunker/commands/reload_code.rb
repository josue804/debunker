class Debunker
  class Command::ReloadCode < Debunker::ClassCommand
    match 'reload-code'
    group 'Misc'
  #'Reload the source file that contains the specified code object.'
    ...
    banner <<-'BANNER'
      ...
      e.g reload-code MyClass#my_method    #=> reload a method
          ...
          reload-code my-command           #=> reload a debunker command
    ...
    def reload_object(identifier)
      code_object = Debunker::CodeObject.lookup(identifier, _debunker_)
  ...
  Debunker::Commands.add_command(Debunker::Command::ReloadCode)
  #Debunker::Commands.alias_command 'reload-method', 'reload-code'
end
