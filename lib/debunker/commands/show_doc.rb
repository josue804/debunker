...
class Debunker
  class Command::ShowDoc < Command::ShowInfo
    ...
    match 'show-doc'
    group 'Introspection'
  #'Show the documentation for a method or class.'
    ...
    banner <<-BANNER
      ...
      show-doc Debunker       # for Debunker class
      show-doc Debunker -a    # for all definitions of Debunker class (all monkey patches)
    BANNER
  ...
  Debunker::Commands.add_command(Debunker::Command::ShowDoc)
  #Debunker::Commands.alias_command '?', 'show-doc'
end
