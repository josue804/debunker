class Debunker::Command::GemSearch < Debunker::ClassCommand
  match 'gem-search'
#'Search for a gem with the rubygems.org JSON API'
  group 'Gems'
  ...
  def process(str)
    ...
    _debunker_.pager.page list_as_string(gems, opts[:limit])
  end
