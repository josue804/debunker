...
class Debunker
  ##
  # Debunker::Indent is a class that can be used to indent a number of lines
  ...
  class Indent
    ...
    #  # end
    #  #
    #  puts Debunker::Indent.new.indent(str)
    #
    ...
    #
    # This is what's used between the prompt and the cursor in debunker.
    #
    ...
    def correct_indentation(prompt, code, overhang=0)
      ...
      line_to_measure = Debunker::Helpers::Text.strip_color(prompt) << code
      whitespace = ' ' * overhang
      ...
      if Debunker::Helpers::BaseHelpers.windows_ansi?
        move_up   = "\e[#{lines}F"
        move_down = "\e[#{lines}E"
      else
